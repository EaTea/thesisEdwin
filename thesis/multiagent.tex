...
\begin{figure}[ht!]
	...
	\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2cm,
			...
			\path[edge]
						...
						(3) edge node {$A$} (4)
	\end{tikzpicture}
	\caption{$M^1$, the model we would have generated using Corollary \ref{approximatingBRestricted}}.}
	\label{beforefigure}
	\end{subfigure}
	~
	\begin{subfigure}[b]{.45\textwidth}
	...
	\end{subfigure}
	\caption{We compare models $M^1$ and $M^2$. It is clear to see that although $M^1$ and $M^2$
