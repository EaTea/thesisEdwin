...
\\
We will now show that this language always constructs $\AXKFF$ action models, and that any
$\AXKFF$ action model can be constructed by our language, up to $n$-bisimilarity.
