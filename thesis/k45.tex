...
We formally submmarise and show this in Theorem 
...
\begin{proof}
  ...
  By \FIXME we can construct an event model that is $n$-bisiilar to
  the unwound model \FIXME using $\EM(\to,\sqcup,I)$.
  By Lemma \ref{lemma:onlyk45Models}, $\evM'_{\evT'}$ is a $\AXKFF$ event model.
  Since we have constructed a model that is $n$-bisimilar to 
\end{proof}
