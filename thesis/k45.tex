...
We say that an action model is {\em composable} by $\EM(\{\to, \sqcup, I\}, \insaneClass)$ if it is
inside the language.
We will now show that $\EM(\{\to, \sqcup, I\}, \insaneClass)$ always constructs $\AXKFF$ action models, and that any
$\AXKFF$ action model is composable by $\EM(\{\to,\sqcup,I\},\insaneClass)$, up to $n$-bisimilarity.
...
must hold
\begin{enumerate}
	\item we can use our language to construct $\AXKFF$ action models
	\item a $\AXKFF$ action model can be constructed (up to $n$-bisimilarity) by our
		language
\end{enumerate}

We show that the first proposition --- that $\EM(\{\to,\sqcup,I\}, \insaneClass)$ will construct
$\AXKFF$ action models.
...
We have shown that any composable action models of $\EM(\{\to,\sqcup,I\}, \insaneClass)$ is a
$\AXKFF$ action models.
...
that is composable using $\EM(\{\to,\sqcup,I\}, \insaneClass)$ and is $n$-bisimilar to $\evM_\evT$?\\
\\
