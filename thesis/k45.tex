\section{Constructing event models in $\AXKFF$} \label{chapter:k45}
...
\subsection{Background} \label{subsec:k45:background}
...
\subsection{Technical Preliminaries} \label{subsec:k45:techPrelims}
...
\subsection{Event model construction and goal achievement in $\AXKFF$}
\label{subsec:k45:goalAchievement}
...
\begin{proof}
  ...
  forth-$a$} and {\bf back-$a$} hold.\\
	...
	outlined in Lemma \ref{lemma:k45frameconditions}).
