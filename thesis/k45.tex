...
We show that the first proposition --- that $\EM(\to,\sqcup,I)$ will construct $\AXKFF$ event
models.
...
\begin{proof}
	...
	\begin{itemize}
		\item We first examine the atoms used in $\EM(\to,\sqcup,I)$ and show that they are $\AXKFF$ event
	models.\\
	\\
