...
Another important system that features within this paper involves only $\axK$, $\axFo$ and $\axFi$.
Although the models in this system model neither knowledge or belief ({\bf T} and {\bf D} are not
necessarily preserved), they somewhat resemble epistemic or doxastic models.
This is due to most of the knowledge and belief axioms being preserved in this system.
Thus, some of our main results are in this axiomatic system, due to its resemblance to knowledge and
belief.\\
\\
