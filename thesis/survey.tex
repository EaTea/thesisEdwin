\section{Literature Survey --- fixed by 25 August 2013} \label{lit_survey}
...
\subsection{Epistemic Modal logic}\label{epistemic_modal_logic}
...
Aucher discusses epistemic planning; that is, supposing we had an information goal
and a current information state, what is the update we would need to get to the information goal
from the current state?
What is most interesting is that Aucher provides a framework to reason about the properties of updates.
...
\\
We thus have that tthe state of the art in action models and this section of dynamic epistemic
