\section{Technical preliminaries} \label{chapter:prelim}
...
\subsection{Models} \label{subsec:prelim:models}
...
\\
Figure \ref{figure:eventModelExample} gives us an example of an event model, in terms of Alice, Bob and
...
\subsection{Bisimilarity, simulation and refinement} \label{subsec:prelim:bisimulation}
...
\subsection{Language semantics} \label{subsec:prelim:semantics}
