...
point in a model.\\
\\
As the language of arbitrary aciton model logic relies upon modal logic, action model logic and
...
(\ref{modalLogic:semantics}), but with the additional
inductive cases
\begin{itemize}
...
(\ref{modalLogic:semantics}), but with the additional inductive case
\[
