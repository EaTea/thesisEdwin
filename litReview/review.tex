...
Theorists have constructed models that captures an update and the changes of
information entials.
...
\\
In a similar manner to models of knowledge, models of information change can be
used for formally reason about updates.
...
communication and execute it in a real world system is a related and unanswered question.
