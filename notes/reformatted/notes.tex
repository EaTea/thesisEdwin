...
\begin{proof}
This result follows trivially from the definition of a finite forest event model and a finite tree
event model, the fact that a finite tree event model is also a finite forest event model and Lemma \ref{disjForestIsForest}.
\end{proof}
...
argument, from any single-agent event model involving agent $a$ trivially being an $a$-restricted
event model, from Lemma \ref{eventModelsRefine} and the completeness of \AXAAML.
\end{proof}
