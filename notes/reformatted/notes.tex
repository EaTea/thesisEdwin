...
We say $\eventClass_{PA}$ is the class of all action models that
...
$\eventClass_{IN} = \{M | \phi \in L\}$ is the class of all such action models,
...
\begin{lemma}
Let $\phi = \pi \land \cover \Gamma \in \langArbAct$, where $\Gamma$ is a finite set.
